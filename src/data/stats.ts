...
type FormStats = [number, number, number, number, number, number];
type PokemonStats = Array<FormStats>;

const stats: { [nationalId: string]: PokemonStats } = {
  "1": [[45, 49, 49, 65, 65, 45]],
  "2": [[60, 62, 63, 80, 80, 60]],
  "3": [[80, 82, 83, 100, 100, 80], [80, 100, 123, 122, 120, 80]],
  "4": [[39, 52, 43, 60, 50, 65]],
  "5": [[58, 64, 58, 80, 65, 80]],
  "6": [
    [78, 84, 78, 109, 85, 100],
  ...
  "7": [[44, 48, 65, 50, 64, 43]],
  "8": [[59, 63, 80, 65, 80, 58]],
  "9": [[79, 83, 100, 85, 105, 78], [79, 103, 120, 135, 115, 78]],
  "10": [[45, 30, 35, 20, 20, 45]],
  "11": [[50, 20, 55, 25, 25, 30]],
  "12": [[60, 45, 50, 90, 80, 70]],
  "13": [[40, 35, 30, 20, 20, 50]],
  "14": [[45, 25, 50, 25, 25, 35]],
  "15": [[65, 90, 40, 45, 80, 75], [65, 150, 40, 15, 80, 145]],
  "16": [[40, 45, 40, 35, 35, 56]],
  "17": [[63, 60, 55, 50, 50, 71]],
  "18": [[83, 80, 75, 70, 70, 101], [83, 80, 80, 135, 80, 121]],
  "19": [[30, 56, 35, 25, 35, 72], [30, 56, 35, 25, 35, 72]],
  "20": [[55, 81, 60, 50, 70, 97], [75, 71, 70, 40, 80, 77]],
  "21": [[40, 60, 30, 31, 31, 70]],
  "22": [[65, 90, 65, 61, 61, 100]],
  "23": [[35, 60, 44, 40, 54, 55]],
  "24": [[60, 95, 69, 65, 79, 80]],
  "25": [[35, 55, 40, 50, 50, 90]],
  "26": [[60, 90, 55, 90, 80, 110], [60, 85, 50, 95, 85, 110]],
  "27": [[50, 75, 85, 20, 30, 40], [50, 75, 90, 10, 35, 40]],
  "28": [[75, 100, 110, 45, 55, 65], [75, 100, 120, 25, 65, 65]],
  ...
  "37": [[38, 41, 40, 50, 65, 65], [38, 41, 40, 50, 65, 65]],
  "38": [[73, 76, 75, 81, 100, 100], [73, 67, 75, 81, 100, 109]],
  ...
  "50": [[10, 55, 25, 35, 45, 95], [10, 55, 30, 35, 45, 90]],
  "51": [[35, 100, 50, 50, 70, 120], [35, 100, 60, 50, 70, 110]],
  "52": [[40, 45, 35, 40, 40, 90], [40, 35, 35, 50, 40, 90]],
  "53": [[65, 70, 60, 65, 65, 115], [65, 60, 60, 75, 65, 115]],
  ...
  "65": [[55, 50, 45, 135, 95, 120], [55, 50, 65, 175, 105, 150]],
  ...
  "74": [[40, 80, 100, 30, 30, 20], [40, 80, 100, 30, 30, 20]],
  "75": [[55, 95, 115, 45, 45, 35], [55, 95, 115, 45, 45, 35]],
  "76": [[80, 120, 130, 55, 65, 45], [80, 120, 130, 55, 65, 45]],
  "77": [[50, 85, 55, 65, 65, 90]],
  "78": [[65, 100, 70, 80, 80, 105]],
  "79": [[90, 65, 65, 40, 40, 15]],
  "80": [[95, 75, 110, 100, 80, 30], [95, 75, 180, 130, 80, 30]],
  ...
  "88": [[80, 80, 50, 40, 50, 25], [80, 80, 50, 40, 50, 25]],
  "89": [[105, 105, 75, 65, 100, 50], [105, 105, 75, 65, 100, 50]],
  "90": [[30, 65, 100, 45, 25, 40]],
  "91": [[50, 95, 180, 85, 45, 70]],
  "92": [[30, 35, 30, 100, 35, 80]],
  "93": [[45, 50, 45, 115, 55, 95]],
  "94": [[60, 65, 60, 130, 75, 110], [60, 65, 80, 170, 95, 130]],
  ...
  "103": [[95, 95, 85, 125, 75, 55], [95, 105, 85, 125, 75, 45]],
  "104": [[50, 50, 95, 40, 50, 35]],
  "105": [[60, 80, 110, 50, 80, 45], [60, 80, 110, 50, 80, 45]],
  ...
  "115": [[105, 95, 80, 40, 80, 90], [105, 125, 100, 60, 100, 100]],
  ...
  "127": [[65, 125, 100, 55, 70, 85], [65, 155, 120, 65, 90, 105]],
  "128": [[75, 100, 95, 40, 70, 110]],
  "129": [[20, 10, 55, 15, 20, 80]],
  "130": [[95, 125, 79, 60, 100, 81], [95, 155, 109, 70, 130, 81]],
  ...
  "142": [[80, 105, 65, 60, 75, 130], [80, 135, 85, 70, 95, 150]],
...
export const getNationalIds = () =>
  Object.keys(stats)
    .sort()
    .map(Number);

export const getNumberOfForms = (nationalId: number) =>
  stats[nationalId].length;

export const getStats = (nationalId: number, form: number = 0) =>
  stats[nationalId][form];
